    ...
    <form role="form" method="post" action="<?= site_url('perawatan/simpan') ?> ">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="tgl_perawatan" id="tgl_perawatan" placeholder="Tanggal Perawatan" required>
            </div>
            <div class="form-group">
                <label for="biaya">Biaya</label>
                <input type="number" class="form-control" name="biaya" id="biaya" placeholder="Biaya Perawatan Kendaraan" required>
            </div>
            <div class="form-group">
