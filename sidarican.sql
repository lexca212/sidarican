...
--
-- Host: localhost
-- Waktu pembuatan: 31 Okt 2025 pada 10.37
...
CREATE TABLE `data_kendaraan` (
  ...
  `bbm_kendaraan` varchar(255) NOT NULL,
...
INSERT INTO `data_kendaraan` (`id_kendaraan`, `nm_kendaraan`, `merk_kendaraan`, `nopol_kendaraan`, `bbm_kendaraan`, `tahun_kendaraan`) VALUES
(1, 'Grandis', 'Mitsubishi', 'AD 1234 GG', 'Pertalite', 2018);
...
(1, 'Lexca Helga', 'admin', '21232f297a57a5a743894a0e4a801fc3');
...
CREATE TABLE 'perjalanan' (
  'id_perjalanan' int(11) NOT NULL PRIMARY KEY,
...
INSERT INTO `data_kendaraan` (`id_kendaraan`, `nm_kendaraan`, `merk_kendaraan`, `nopol_kendaraan`, `kd_bbm`, `tahun_kendaraan`) VALUES
(1, 'Grandis', 'Mitsubishi', 'AD 1234 GG', 'Pertalite', 2018),
(2, 'Jazz', 'Honda', 'AD 2233 GG', 'Pertalite', 2021),
(3, 'Trontong', 'Suzuki', 'AD 1122 GG', 'Solar', 2025),
(7, 'Prosche', 'Honda', 'AD 2233 GG', 'PL01', 2021);
...
INSERT INTO `master_bbm` (`kd_bbm`, `nama_bbm`, `harga_bbm`) VALUES
('PL01', 'Pertalite', '10000'),
('SR01', 'Solar', '5000');
